...
async function buildApp() {
  ...
  const defaultCorsOrigins = ['http://localhost:3000', 'http://localhost:3002', 'https://www.wisesama.com', 'https://wisesama.com', 'https://wisesama-admin.vercel.app', 'https://admin.wisesama.com'];
