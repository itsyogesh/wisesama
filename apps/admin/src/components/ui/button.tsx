...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-wisesama-purple text-white shadow hover:bg-wisesama-purple-accent',
        destructive:
          'bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90',
        outline:
          'border border-white/10 bg-transparent text-white shadow-sm hover:bg-white/5',
        secondary:
          'bg-wisesama-dark-secondary text-white shadow-sm hover:bg-wisesama-dark-secondary/80',
        ghost: 'text-white/60 hover:bg-white/5 hover:text-white',
        link: 'text-wisesama-purple underline-offset-4 hover:underline',
      },
      size: {
